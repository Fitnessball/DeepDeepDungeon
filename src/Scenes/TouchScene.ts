...
export default class TouchScene extends Phaser.Scene {
 ...
 create(){
    ...
    this.buttonAttack = new SceneButtons(this,214+XoffsetA,177+YoffsetA,'GBC_Attack_UP','GBC_Attack_DOWN')
    this.arrowDown = new SceneButtons(this,106+Xoffset,226+Yoffset,'GBC_Cross_Down_UP','GBC_Cross_Down_DOWN');
    this.arrowUp = new SceneButtons(this,106+Xoffset,164+Yoffset,'GBC_Cross_Up_UP','GBC_Cross_Up_DOWN');
    this.arrowLeft = new SceneButtons(this,73+Xoffset,195+Yoffset,'GBC_Cross_Left_UP','GBC_Cross_Left_DOWN');
    this.arrowRight = new SceneButtons(this,139+Xoffset,195+Yoffset,'GBC_Cross_Right_UP','GBC_Cross_Right_DOWN');
